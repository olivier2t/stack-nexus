...
output "vpc_id" {
  ...
  value       = data.terraform_remote_state.outputs.infra.vpc_id
}

output "public_subnets" {
  description = "The public subnets for the VPC"
  value       = data.terraform_remote_state.outputs.public_subnets
}

output "bastion_ip" {
  description = "The IP address of the bastion."
  value       = data.terraform_remote_state.outputs.infra.bastion_ip
}
